...
namespace CoScheduling.Core.Model
{
    public class TASKSCHEME_PRIVATE_ORBIT
    {
        ...
        public TASKSCHEME_PRIVATE_ORBIT(decimal sAT_ID, string sAT_ORBITEPOCH, string sAT_MEANMOTION, string sAT_ECCENTRICITY, string sAT_INCLINATION, string sAT_ARGOFPERIGEE, string sAT_RAAN, string sAT_MEANANOMALY, string sAT_MEANMOTIONDOT, string sAT_MEANMOTIONDOTDOT, string sAT_BSTAR, string sAT_TLE1, string sAT_TLE2,int sCHEMEID)
		{
			_sAT_ID = sAT_ID;
