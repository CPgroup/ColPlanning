...
namespace CoScheduling.Core.Model
{
    ...
    {
        public TASKSCHEME_PRIVATE_SENSOR()
        { }

        /// <summary>
        /// 构造函数 TASKSCHEME_PRIVATE_SENSOR
        /// </summary>
        ...
        public TASKSCHEME_PRIVATE_SENSOR(decimal sENSOR_ID, string sENSOR_NAME, string sENSOR_STKNAME, decimal sAT_ID, string sAT_STKNAME, string sENSOR_TYPE, decimal sENSOR_PARONE, decimal sENSOR_PARTWO, decimal sENSOR_PARTHREE, decimal sENSOR_PARFOUR, decimal tYPEID, decimal sATTYPE, decimal sCHEMEID, decimal sENSORANGLEH, decimal sENSORANGLE)
        {
