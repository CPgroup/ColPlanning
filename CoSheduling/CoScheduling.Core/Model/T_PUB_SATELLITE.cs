...
namespace CoScheduling.Core.Model
{
    ...
    public class T_PUB_SATELLITE
    {
        ...
        public T_PUB_SATELLITE(decimal sAT_ID, string sAT_NAME, string sAT_STKNAME, decimal sAT_TYPE, string sAT_ROPAGATOR, decimal sAT_STEP, string sAT_COORD, decimal sEMIMAJORAXIS, decimal eCCENTRICITY, decimal iNCLINATION, decimal aOP, decimal rAAN, decimal mEANANOMALY, decimal tRUEANOMALY)
        {
            _sAT_ID = sAT_ID;
            _sAT_NAME = sAT_NAME;
