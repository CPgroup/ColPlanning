...
namespace CoScheduling.Main.AEROSHIP
{
    public partial class BandModify : Form
    {
        ...
        CoScheduling.Core.Model.AEROSHIP_RANGE aeroship_range = new CoScheduling.Core.Model.AEROSHIP_RANGE();
        ...
        private void BandModify_Load(object sender, EventArgs e)
        {
            ...
            this.txtAEROSHIPID.Text += sensor1.PLATFORM_ID;
