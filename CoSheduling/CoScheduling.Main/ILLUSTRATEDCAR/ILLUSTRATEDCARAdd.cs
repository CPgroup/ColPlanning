...
{
    public partial class ILLUSTRATEDCARAdd : Form
    {
        public ILLUSTRATEDCARAdd()
        {
            InitializeComponent();
        }
        /// <summary>
        ...
        private void ButtonAdd_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //添加
                dal_illustratedcar_range.Add(illustratedcar_range);
                MessageBox.Show("地面测量车添加成功！");
                //回传给父窗体消息
        ...
        {
            (this.txtPlatformID.Text) = "500002";
            this.txtPlatformName.Text = "No.2 ILLUSTRATEDCAR";
            (this.txtNumberOfSensor.Text) = "1";
            (this.txtMaxVelocity.Text) = "24";
            this.txtAcceleration.Text = "5";
            (this.txtMaxDistance.Text) = "30";
            (this.txtApprochAngle.Text) = "10";
            (this.txtDepartureAngle.Text) = "5";
            (this.txtMinGoundClearance.Text) = "30";
            (this.txtWheelBase.Text) = "30";
            (this.txtAziAngle.Text) = "30";
            (this.txtAziAngleVelocity.Text) = "200";
            (this.txtPitAngle.Text) = "500";
            (this.txtPitAngleVelocity.Text) = "12";
            (this.txtPolAngle.Text) = "5";
            (this.txtPolAngleVelocity.Text) = "5";
