...
namespace CoScheduling.Main.SPYCAM_RANGE
{
    ...
    public partial class SENSOR2Add : Form
    {
        ...
        {
            spycam_range = dal_spycam_range.GetModel(Convert.ToInt32(platform_id));
            this.labelPLATFORM.Text = spycam_range.PLATFORM_Name;
